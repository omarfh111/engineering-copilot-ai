...
public class ReviewController {
    ...
    @GetMapping
    public ResponseEntity<PagedResponse<ReviewSummaryResponse>> getReviews(@Valid @ModelAttribute ReviewSearchRequest request) {
        return ResponseEntity.ok(workspaceReadService.getReviews(request));
    }
}
